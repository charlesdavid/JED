...
public class JED_Do_Dist_Pairs
	{
		...
		double trace_dist_COV, trace_dist_CORR, trace_dist_P_CORR, cond_cov, cond_corr, cond_pcorr, det_cov, det_corr, det_pcorr, rank_cov, rank_corr,
				rank_pcorr, z_cutoff;
		...
		Matrix distance_matrix, distance_matrix_cond, original_PDB_coordinates, subset_PDB_coordinates_dist, transformed_subset_PDB_coordinates_dist, cov_dist,
				corr_dist, top_distance_evectors_COV, top_distance_evectors_CORR, top_distance_evectors_P_CORR, normed_projections_dist_COV,
				projections_dist_COV, projections_dist_CORR, normed_projections_dist_CORR, weighted_normed_projections_dist_COV,
		...
		private void get_Distance_Pair_DVPs()
			{
				JED_Get_Distance_Pair_DVPs SS_dvp_COV = new JED_Get_Distance_Pair_DVPs(distance_matrix, top_distance_evectors_COV, top_distance_eigenvalues_COV,
						reference_column, directory, description, "COV", number_of_modes_dist_pairs);
					{
						// COVARIANCE METHOD
						SS_dvp_COV.get_Distance_Pair_DV_Series();
						SS_dvp_COV.get_DVPs();
					}
				JED_Get_Distance_Pair_DVPs SS_dvp_CORR = new JED_Get_Distance_Pair_DVPs(distance_matrix, top_distance_evectors_CORR,
						top_distance_eigenvalues_CORR, reference_column, directory, description, "CORR", number_of_modes_dist_pairs);
					{
						// CORRELATION METHOD
						SS_dvp_CORR.get_Distance_Pair_DV_Series();
						SS_dvp_CORR.get_DVPs();
					}
				JED_Get_Distance_Pair_DVPs SS_dvp_PCORR = new JED_Get_Distance_Pair_DVPs(distance_matrix, top_distance_evectors_CORR,
						top_distance_eigenvalues_CORR, reference_column, directory, description, "PCORR", number_of_modes_dist_pairs);
					{
						// PARTIAL CORRELATION METHOD
						SS_dvp_PCORR.get_Distance_Pair_DV_Series();
						SS_dvp_PCORR.get_DVPs();
					}
			}
