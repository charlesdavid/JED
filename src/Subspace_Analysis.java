...
/**
 * JED class Subspace_Analysis: Core class for performing comparative subspace analysis.
...
public class Subspace_Analysis
{
	...
	Matrix Avg_RMSIP_Score_Matrix, RMSIP_Std_Dev_Matrix, Avg_CO_Score_Matrix, Avg_PA_Matrix, data1, data2, matrix1, matrix2, projections, projections_abs, projections_squared, CO_matrix_1_2,
			CO_matrix_2_1, input_matrix_1, input_matrix_2, vector1, vector2, PAs, rand;
	ArrayList<Double> projections_squared_CO_k, projections_squared_RMSIP, cumulative_overlaps_1_2, cumulative_overlaps_2_1, principle_angles_svd, cosine_products, vectorial_sum_of_angles, RMSIPs;
	File file_1, file_2, Job_log, Batch_log;

	/* ***************************** CONSTRUCTOR ************************************************************* */

	/**
	 * Constructor to initiate the subspace analysis of two sets of eigenvectors.
	 * The sets of eigenvectors are equidimensional bases for subspaces of the eigenspaces of the trajectories.
	 * 
	 * @param basis1
	...
	public void get_SSA()
		{
			...
			projections_squared_CO_k = new ArrayList<Double>();
			projections_squared_RMSIP = new ArrayList<Double>();
	...
	/**
	 * Method to compute the iterated fast subspace analysis.
	 * Iterates from dim 1 to the dim of the entered data.
	 * RMSIPs and PAs are calculated.
	 */
	...
	/**
	 * Method to compute an iterated subspace analysis of random bases.
	 * This can be a used to form a baseline for statistical significance of RMSIP and PA scores.
	 */
