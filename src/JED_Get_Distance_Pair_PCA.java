...
/**
 * JED class JED_Get_Distance_PCA: Gets the COV and CORR PCA for the Residue Distance Pairs subset.
...
public class JED_Get_Distance_Pair_PCA
{
	...
	String directory, out_dir_dpPCA, out_dir_COV, out_dir_CORR, description, file_name_head, path;
	...
	private void get_eigenvalues_COV()
		{
			...
			double min = eigenvalues_COV.get(ROWS_DP - 1);
	...
	private void get_eigenvalues_CORR()
		{
			...
			double min = eigenvalues_CORR.get(ROWS_DP - 1);
