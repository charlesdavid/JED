...
/**
 * JED class Projector: Core class that computes inner products, normed arrays, and correlations.
...
public class Projector
{
	/**
	 * @param in_Vector
	 *            The vector to be normalized (Norm F)
	 ...
	 * @param vector1
	 * @param vector2
	 * @return The inner product (vector1 dot vector2)
	 */
