...
public class JED_Do_Cartesian
{
	...
	public Matrix original_PDB_coordinates, subset_PDB_coordinates, transformed_PDB_coordinates, cov, top_cartesian_evectors_COV, square_pca_modes_COV, weighted_square_pca_modes_COV,
			...
			pca_modes_COV, pca_modes_CORR, normed_projections_CORR, projections_CORR, top_cartesian_evectors_PCORR, square_pca_modes_PCORR, weighted_square_pca_modes_PCORR,
			weighted_pca_modes_PCORR, pca_modes_PCORR, normed_projections_PCORR, projections_PCORR, conf_z_scores, var_z_scores;
	...
	public JED_Do_Cartesian(String directory, String description, String pdb_ref, String rl_SS, int reference_column, int number_of_modes_SS, Matrix original_PDB_coordinates)
		{
	...
	private void get_Transformed_Coords()
		{
			JED_Get_Transformed_Coordinates tf_coords = new JED_Get_Transformed_Coordinates(subset_PDB_coordinates, reference_column, directory, description);
				{
	...
	private void get_Cartesian_DVPs()
		{
			JED_Get_Cartesian_DVPs pcs_cov = new JED_Get_Cartesian_DVPs(transformed_PDB_coordinates, top_cartesian_evectors_COV, eigenvalues_COV, reference_column, directory, description, Q);
				{
					pcs_cov.get_Cartesian_DV_Series();
				}
			JED_Get_Cartesian_DVPs pcs_corr = new JED_Get_Cartesian_DVPs(transformed_PDB_coordinates, top_cartesian_evectors_CORR, eigenvalues_CORR, reference_column, directory, description, R);
				{
					pcs_corr.get_Cartesian_DV_Series();
				}
			JED_Get_Cartesian_DVPs pcs_pcorr = new JED_Get_Cartesian_DVPs(transformed_PDB_coordinates, top_cartesian_evectors_PCORR, eigenvalues_PCORR, reference_column, directory, description, P);
				{
