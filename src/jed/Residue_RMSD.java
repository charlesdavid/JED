...
public class Residue_RMSD
{
	...
	/**
	 * Constructor that uses the pdb coordinates to calculate the residue rmsds.
	 */
	...
	/**
	 * Method that returns a matrix of residue rmsds.
	 */
	...
	/**
	 * @return A Java List of residue rmsds (RMSF) based on the entire trajectory.
	 */
	public List<Double> get_residue_rmsd()
		{
			...
			ArrayList<Double> residue_rmsds = new ArrayList<>();
