...
/**
 * JED class JED_Batch_Driver: Driver program for running JED in (sequential) batch mode. Input file is "JED_Batch_Driver.txt" Copyright (C) 2012 Dr. Charles
 * David
 *
...
public class JED_Batch_Driver
	{
		...
		static int number_Of_Input_Lines, line_count, num_of_jobs, job_num, number_of_modes_cartesian, number_of_modes_dist_pairs, number_of_residue_pairs,
				number_of_modes_viz, number_of_residues_cartesian, ROWS, COLS;
		static String input_path, path, name, directory, out_dir, rl_cartesian, rl_dist_pairs, coord_input_file, description, pdb_ref_file, line, date,
				Q = "COV", R = "CORR", P = "PCORR";
		static double trace_COV, trace_d_cov, trace_CORR, trace_d_corr, trace_PCORR, trace_d_pcorr, cond_cov, det_cov, rank_cov, cond_d_cov, det_d_cov,
				rank_d_cov, mode_amplitude, z_cut, percent;
		...
		static double[] pca_mode_min_COV, pca_mode_max_COV, pca_mode_min_CORR, pca_mode_max_CORR, pca_mode_max_PCORR, pca_mode_min_PCORR,
				residue_distance_means, residue_distance_std_devs;
		static Matrix original_reference_PDB_coordinates, original_PDB_coordinates, subset_PDB_coordinates_cartesian, weighted_pca_modes_COV,
				square_pca_modes_COV, weighted_square_pca_modes_COV, transformed_PDB_coordinates_cartesian, distance_matrix, top_cartesian_evectors_COV,
				...
				weighted_normed_projections_COV, weighted_normed_projections_CORR, pca_modes_CORR, pca_modes_COV, top_cartesian_evectors_PCORR,
				top_distance_evectors_PCORR, square_pca_modes_PCORR;
		...
		private static void do_Mode_Visualization()
			{
				...
				JED_PCA_Mode_Vizualization pcorr = new JED_PCA_Mode_Vizualization(directory, description, atoms, top_cartesian_eigenvalues_PCORR,
						top_cartesian_evectors_PCORR, square_pca_modes_PCORR, pca_mode_max_PCORR, pca_mode_min_PCORR, mode_amplitude, number_of_modes_viz, P);
