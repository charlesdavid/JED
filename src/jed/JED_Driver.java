...
public class JED_Driver
{
	...
	static int number_Of_Input_Lines, line_count, number_of_modes_cartesian, number_of_modes_dist_pairs, number_of_modes_viz, number_of_residues_cartesian, number_of_residue_pairs,
			ROWS, COLS;
	static String input_path, path, name, directory, out_dir, rl_cartesian, rl_dist_pairs, coord_input_file, description, pdb_ref_file, line, date, Q = "COV", R = "CORR",
			PC = "PCORR";
	static double trace_COV, trace_d_cov, trace_CORR, trace_d_corr, trace_d_pcorr, trace_PCORR, cond_cov, cond_d_cov, cond_corr, cond_d_corr, cond_pcorr, cond_d_pcorr, det_cov,
			det_d_cov, det_corr, det_d_corr, det_pcorr, det_d_pcorr, rank_cov, rank_d_cov, rank_corr, rank_d_corr, rank_pcorr, rank_d_pcorr, mode_amplitude, z_cut, percent;
	...
	static Matrix original_reference_PDB_coordinates, tranasformed_reference_PDB_coordinates, original_PDB_coordinates, subset_PDB_coordinates_cartesian, weighted_pca_modes_COV,
			square_pca_modes_COV, weighted_square_pca_modes_COV, transformed_PDB_coordinates_cartesian, distance_matrix, top_cartesian_evectors_COV, top_distance_evectors_COV,
			projections_COV, normed_projections_COV, weighted_pca_modes_CORR, square_pca_modes_CORR, square_pca_modes_PCORR, weighted_square_pca_modes_CORR,
			top_cartesian_evectors_CORR, top_cartesian_evectors_PCORR, top_distance_evectors_CORR, top_distance_evectors_PCORR, projections_CORR, normed_projections_CORR,
			weighted_normed_projections_COV, weighted_normed_projections_CORR, pca_modes_CORR, pca_modes_COV;
