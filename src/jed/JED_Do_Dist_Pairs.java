...
public class JED_Do_Dist_Pairs
{
	...
	Matrix reference_pdb_coordinates, reference_distances, distance_matrix, distance_matrix_cond, original_PDB_coordinates, subset_PDB_coordinates_dist, transformed_subset_PDB_coordinates_dist,
			cov_dist, corr_dist, top_distance_evectors_COV, top_distance_evectors_CORR, top_distance_evectors_PCORR, Z_scores, counts;
	Matrix normed_projections_dist_COV, projections_dist_COV, projections_dist_CORR, normed_projections_dist_CORR, weighted_normed_projections_dist_COV, weighted_normed_projections_dist_CORR,
			weighted_projections_dist_COV, weighted_projections_dist_CORR, normed_projections_dist_PCORR, projections_dist_PCORR;
	...
	public JED_Do_Dist_Pairs(String dir, String desc, String ref_file, String res_dist_pairs, int modes_dist_pairs, Matrix PDB_coordinates, Matrix ref_coords)
		{
			super();
			directory = dir;
			description = desc;
			pdb_ref_file = ref_file;
			out_dir = directory + "JED_RESULTS_" + description + File.separatorChar + "dpPCA" + File.separatorChar;
	...
	private void get_Distance_Pair_DVPs()
		{
			JED_Get_Distance_Pair_DVPs SS_dvp_COV = new JED_Get_Distance_Pair_DVPs(distance_matrix, reference_distances, top_distance_evectors_COV, top_distance_eigenvalues_COV, directory,
					description, "COV", number_of_modes_dist_pairs);
				{
					// COVARIANCE METHOD
			...
			JED_Get_Distance_Pair_DVPs SS_dvp_CORR = new JED_Get_Distance_Pair_DVPs(distance_matrix, reference_distances, top_distance_evectors_CORR, top_distance_eigenvalues_CORR, directory,
			...
			JED_Get_Distance_Pair_DVPs SS_dvp_PCORR = new JED_Get_Distance_Pair_DVPs(distance_matrix, reference_distances, top_distance_evectors_CORR, top_distance_eigenvalues_CORR, directory,
	...
	private void get_Reference_Residue_Pair_Distances()
		{
			JED_Get_Distances_for_Residue_Pairs ref_dist_pairs = new JED_Get_Distances_for_Residue_Pairs(reference_pdb_coordinates, res_list_dist1, res_list_dist2, directory, description);
				{
