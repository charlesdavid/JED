...
/**
 * JED class Principal_Angles: This class computes the principle angles from a matrix of overlaps (projections) using SVD. Copyright (C) 2012 Dr. Charles David
 * 
...
public class Principal_Angles
{
	...
	/**
	 * Constructor to compute the principal angles between two equidimensional subspaces of a vector space. This class takes as input the matrix of inner products between the two
	 * orthonormal bases. If the two subspaces are 20 dimensional, the matrix of inner products will be a 20 x 20 square symmetric matrix
	 * 
	 * @param m
	 ...
	 * orthonormal sets of eigenvectors. IF the sets of eigenvectors are NOT orthonormal, then the singular values will NOT be in the range [0,1] This method will set any values
	 * out of range of the cosine function to the closest value in range.
	 * 
	 * @param projections
