...
public class JED_Get_Cartesian_DVPs
{
	 ...
	 * @param ref_coords
	 *            The Reference coordinates from the reference PDB file
	 * @param evects
	 ...
	 */
	JED_Get_Cartesian_DVPs(Matrix data, Matrix ref_coords, Matrix evects, List<Double> evals, String dir, String des, String T)
		{
