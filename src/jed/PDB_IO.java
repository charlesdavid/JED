...
/**
 * JED class PDB_IO: Handles the reading and writing of PDB files using a Fortran Formatter and a PDB File Parser. Catches Exceptions thrown by the PDB File
 * Parser class.
 * 
...
public class PDB_IO
	{
		...
		/**
		 * Constructor for the PDB IO object: Instantiates the PDB reader and the Fortran Formatter.
		 * 
		 * @param dir
		 *            The read directory
		 * @param name
