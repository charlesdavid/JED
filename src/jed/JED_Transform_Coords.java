...
/**
 * JED class JED_Transform_Coords: Core class for calculating the rotation to align a frame to the reference frame. Copyright (C) 2012 Dr. Charles David
 * 
...
public class JED_Transform_Coords
{
	...
	Matrix reference_conformation, conformation, reference_centered_coordinates, centered_coordinates, transformed_vectors, eigen_vectors;
