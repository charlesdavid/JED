...
/**
 * JED class JED_Get_Distance_Pair_DVPs: Constructs the DVPs for the Residue Distance Pairs subset. Note: DVPs are like Principle Components, except that the
 * reference structure is
 * not the mean structure. Copyright (C) 2012 Dr. Charles David
 *
