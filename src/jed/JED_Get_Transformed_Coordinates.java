...
/**
 * JED class JED_Get_Transformed_Coordinates: Optimally aligns all frames of a trajectory to a reference frame using Quaternion operations. Copyright (C) 2012
 * Dr. Charles David
 * 
...
public class JED_Get_Transformed_Coordinates
	{
		...
		static Matrix subset_REF_PDB_coordinates, transformed_subset_REF_PDB_coordinates, subset_PDB_coordinates, transformed_subset_PDB_coordinates,
				trimmed_PDB_coordinates_cols, adjusted_PDB_coordinates_rows, var_Z_scores, conf_Z_scores;
		...
		/**
		 * Constructor for transforming the original coordinates using quaternion operations and calculating the conformation and residue RMSDs. If specified,
		 * the coordinates outliers
		...
		JED_Get_Transformed_Coordinates(Matrix data, Matrix ref_coords, String dir, String des)
			{
				...
				// System.out.println("Subset REF PDB Coords:"); // TEST
				// subset_REF_PDB_coordinates.print(9, 3);
				// System.out.println("Transformed Subset REF PDB Coords:");
				// transformed_subset_REF_PDB_coordinates.print(9, 3); // TEST
			}
				...
				for (int z = 0; z < COLS; z++)
					{
						...
						tf_coords = new JED_Transform_Coords(subset_REF_PDB_coordinates, fc);
