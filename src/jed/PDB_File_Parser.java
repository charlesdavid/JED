...
/**
 * JED class PDB_File_Parser: Parser class to read and write PDb files using Fortran Format. The exceptions thrown by this class are caught by the JED_Read_PDBs class.
 * 
...
class PDB_File_Parser
{
	...
	public PDB_File_Parser()
		{
			chain_IDs_read = new ArrayList<>();
			chainID_list = new ArrayList<>();
			residue_list = new ArrayList<>();
			residues_read = new ArrayList<>();
			residue_ID_pairs_read = new ArrayList<>();
			lines = new ArrayList<>();
		}
