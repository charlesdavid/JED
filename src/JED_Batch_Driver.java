...
public class JED_Batch_Driver
	{
		...
		static int number_Of_Input_Lines, line_count, num_of_jobs, job_num, number_of_modes_cartesian, number_of_modes_dist_pairs, number_of_residue_pairs,
				number_of_modes_viz, number_of_residues_cartesian, reference_column, ROWS, COLS;
		...
		static List<Double> transformed_conformation_rmsds, transformed_residue_rmsds, top_cartesian_eigenvalues_COV, top_distance_eigenvalues_COV,
		...
		static Matrix original_PDB_coordinates, subset_PDB_coordinates_cartesian, weighted_pca_modes_COV, square_pca_modes_COV, weighted_square_pca_modes_COV,
				transformed_PDB_coordinates_cartesian, distance_matrix, Q_cartesian, Q_dist, R_cartesian, R_dist, top_cartesian_evectors_COV,
				top_distance_evectors_COV, projections_COV, normed_projections_COV, weighted_pca_modes_CORR, square_pca_modes_CORR,
				weighted_square_pca_modes_CORR, top_cartesian_evectors_CORR, top_distance_evectors_CORR, projections_CORR, normed_projections_CORR,
		...
		private static void read_batch_parameters()
			{
						...
						if (!sToken.hasMoreElements())
							{
								...
								System.err.println("Setting the mode amplitude to the default value of 1.000");
				...
				if (read_PDBs & do_cartesian || read_PDBs & do_dist_pairs)
					{
				...
				try
					{
						...
						if (!do_multi) log_writer.write("The file '" + name
								+ "' contains all residue numbers found in the PDB file, formatted for Single Chain Analysis Input." + "\n");
						if (do_multi) log_writer.write("The file '" + name
		...
		private static void do_cPCA()
			{
				...
				JED_Do_Cartesian cSS = new JED_Do_Cartesian(directory, description, pdb_ref_file, rl_cartesian, reference_column, number_of_modes_cartesian,
						original_PDB_coordinates);
				...
				trace_P_CORR = cSS.get_Trace_CORR();
		...
		private static void get_cPCA_SSA()
			{
				JED_Get_Subspace_Analysis jssa = new JED_Get_Subspace_Analysis(directory, description, "cPCA", top_cartesian_evectors_COV,
		...
		private static void do_dpPCA()
			{
				JED_Do_Dist_Pairs dpSS = new JED_Do_Dist_Pairs(directory, description, pdb_ref_file, rl_dist_pairs, reference_column,
						number_of_modes_dist_pairs, original_PDB_coordinates);
		...
		private static void get_dpPCA_SSA()
			{
				JED_Get_Subspace_Analysis jssa = new JED_Get_Subspace_Analysis(directory, description, "dpPCA", top_distance_evectors_COV,
				...
				if (do_multi)
					{
						JED_Do_No_PCA npca = new JED_Do_No_PCA(directory, rl_cartesian, chain_ids_read, residues_read, description, pdb_ref_file,
								original_PDB_coordinates, reference_column);
							{
								npca.set_percent_cutoff(percent);
								npca.set_z_cutoff(z_cut);
