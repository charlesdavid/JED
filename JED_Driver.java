...
public class JED_Driver
	{
		...
		static int number_Of_Input_Lines, line_count, number_of_modes_cartesian, number_of_modes_dist_pairs, number_of_modes_viz, number_of_residues_cartesian,
				number_of_residue_pairs, reference_column, ROWS, COLS;
		...
		static Matrix original_PDB_coordinates, subset_PDB_coordinates_cartesian, weighted_pca_modes_COV, square_pca_modes_COV, weighted_square_pca_modes_COV,
				...
				top_distance_evectors_COV, projections_COV, normed_projections_COV, weighted_pca_modes_CORR, square_pca_modes_CORR, square_pca_modes_PCORR,
				weighted_square_pca_modes_CORR, top_cartesian_evectors_CORR, top_cartesian_evectors_PCORR, top_distance_evectors_CORR,
						...
						if (number_Of_Input_Lines < 6)
							{
								...
								System.err.println("THERE MUST BE 8 LINES OF PARAMETERS FOR 1 of 2 PCA analyses.");
								System.err.println("THERE MUST BE 9 LINES OF PARAMETERS FOR 2 of 2 PCA analyses.");
				...
				if (do_cartesian & do_dist_pairs)
					{
						if (number_Of_Input_Lines < 9)
							{
								System.err.println("Nine lines of input required for cPCA AND dpPCA (2 of 2), but only got " + number_Of_Input_Lines);
				...
				if (do_cartesian ^ do_dist_pairs)
					{
						if (number_Of_Input_Lines < 8)
							{
								System.err.println("Eight lines of input required for Either cPCA OR dpPCA (1 of 2), but only got " + number_Of_Input_Lines);
								System.err.println("INSUFFICIENT DATA.");
								System.err.println("One or more of the following is missing:");
								System.err.println("The Cartesian Residue List, the Residue Pairs List, the Matrix of Coordinates with the Reference Column.");
								System.err.println("Terminating program execution.");
		...
		private static void get_dpPCA_SSA()
			{
				JED_Get_Subspace_Analysis jssa1 = new JED_Get_Subspace_Analysis(directory, description, "dpPCA", top_cartesian_evectors_COV,
						top_cartesian_evectors_CORR, "COV_vs_CORR");
					{
						jssa1.get_SSA_JED();
						jssa1.get_FSSA_Iterated_JED();
				...
				JED_Get_Subspace_Analysis jssa2 = new JED_Get_Subspace_Analysis(directory, description, "dpPCA", top_cartesian_evectors_COV,
						top_cartesian_evectors_PCORR, "COV_vs_PCORR");
					{
						jssa2.get_SSA_JED();
						jssa2.get_FSSA_Iterated_JED();
				...
				JED_Get_Subspace_Analysis jssa3 = new JED_Get_Subspace_Analysis(directory, description, "dpPCA", top_cartesian_evectors_CORR,
						top_cartesian_evectors_PCORR, "CORR_vs_PCORR");
					{
						jssa3.get_SSA_JED();
						jssa3.get_FSSA_Iterated_JED();
