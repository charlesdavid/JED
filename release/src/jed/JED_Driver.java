...
public class JED_Driver
{
	...
	static int number_Of_Input_Lines, line_count, number_of_modes_cartesian, number_of_modes_dist_pairs, number_of_modes_viz, number_of_residues_cartesian, number_of_residue_pairs, reference_column,
			ROWS, COLS;
	...
	static Matrix original_PDB_coordinates, subset_PDB_coordinates_cartesian, weighted_pca_modes_COV, square_pca_modes_COV, weighted_square_pca_modes_COV, transformed_PDB_coordinates_cartesian,
			...
			weighted_square_pca_modes_CORR, top_cartesian_evectors_CORR, top_cartesian_evectors_PCORR, top_distance_evectors_CORR, top_distance_evectors_PCORR, projections_CORR,
			normed_projections_CORR, weighted_normed_projections_COV, weighted_normed_projections_CORR, pca_modes_CORR, pca_modes_COV;
