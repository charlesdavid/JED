...
/**
 * JED class FSSA Driver: Driver program for the Fast Subspace Analysis class.
...
public class FSSA_Driver
{
	...
	private static void initialize_Batch_Log()
		{
			Batch_log = new File(out_dir + "FSSA_Batch_Log_" + batch_description + ".txt");
			try
				{
	...
	private static void initialize_Job_Log()
		{
			Job_log = new File(out_dir + "FSSA_Job_Log_" + description + "_dim_" + COLS1 + ".txt");
			try
				{
	...
	public static void main(String[] args)
		{
			...
			System.out.println("Running FSSA Driver: ");
